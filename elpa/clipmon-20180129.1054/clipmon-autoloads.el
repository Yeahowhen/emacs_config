;;; clipmon-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
Start clipboard monitor - watch system clipboard, add changes to kill ring." t nil)
...
`savehist-mode' for more details." nil nil)
